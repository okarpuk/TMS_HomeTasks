...
namespace HomeTask_7_AutoPark_Cars
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<CarInfo> allBikes = new List<CarInfo>()
            {
                bike1,
                bike2,
                bike3
            ...
            foreach (var vehicle in allBikes)
            {
            ...
            List<CarInfo> allPasscars = new List<CarInfo>()
            {
                passCar1,
                passCar2,
                passCar3
            };
            Console.WriteLine("PASSENGER CARS: ");
            foreach (var vehicle in allPasscars)
            {
                vehicle.PrintVehicleInfo();
            }
            Console.WriteLine();
            ...
            List<CarInfo> allFreights = new List<CarInfo>()
            {
                freight1,
                freight2,
                freight3
            };
            Console.WriteLine("FREIGHT CARS: ");
            foreach (var vehicle in allFreights)
            {
                vehicle.PrintVehicleInfo();
            }
            Console.WriteLine();
